...
export default function EventModal({ dateKey, onClose }) {
  ...
  const [rangeBanner, setRangeBanner] = useState(false)
  ...
  const handleRangeSubmit = () => {
    ...
    dispatch({ type: 'ADD_RANGE', dateKeys: dateRange, event: { category: rangeCategory, label: rangeLabel.trim(), time: rangeTime || undefined, banner: rangeBanner || undefined } })
              ...
              <div className="px-5 pt-3 pb-4 space-y-3">
                ...
                <label className="flex items-center gap-2 cursor-pointer select-none">
                  <input
                    type="checkbox"
                    checked={rangeBanner}
                    onChange={e => setRangeBanner(e.target.checked)}
