...
export const YAYOE_EVENTS = {
  ...
  '2026-11-26': [
    { id: 'ev-' + Math.random().toString(36).slice(2), category: 'early-dismissal', label: 'Thanksgiving Kodesh Only Y-8th (12:00)' },
  ],
  '2026-11-27': [
    { id: 'ev-' + Math.random().toString(36).slice(2), category: 'early-dismissal', label: 'Thanksgiving Kodesh Only Y-8th (11:30)' },
  ],
